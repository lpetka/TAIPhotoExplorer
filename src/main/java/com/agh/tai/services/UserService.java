...
public class UserService implements IUserService
{
    ...
    public ImagesList getUserFavourites()
    {
        ...
        try
        {
            ResponseEntity<ImagesList> response = restTemplate
                    .exchange(String.format("%s/account/%s/favorites", REST_SERVICE_URI, userName), HttpMethod.GET, new HttpEntity<>(headers), ImagesList.class);
    ...
    public ImagesList getUserImages(int page)
    {
        ...
        {
            ResponseEntity<ImagesList> response = restTemplate
                    .exchange(String.format("%s/account/%s/images/%d", REST_SERVICE_URI, userName, page), HttpMethod.GET, new HttpEntity<>(headers), ImagesList.class);
